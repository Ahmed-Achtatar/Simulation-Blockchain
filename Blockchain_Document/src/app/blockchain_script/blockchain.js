...
var Transaction = /** @class */ (function() {
    ...
    Transaction.prototype.calculateHash = function() {
        var docsv = new DocumentSV();
        var pdfhash = '';
        // docsv.asyncHash(this.file).then((value => pdfhash = value));
        return SHA256(this.fromAddress + pdfhash + this.timestamp).toString();
    };
    /**
...
const __Blockchain = _Blockchain;
export { __Blockchain as Blockchain };
var _Block = Block;
const __Block = _Block;
export { __Block as Block };
var _Transaction = Transaction;
const __Transaction = _Transaction;
export { __Transaction as Transaction };
