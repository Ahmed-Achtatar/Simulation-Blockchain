...
var DocumentSV = /** @class */ (function () {
    ...
    function DocumentSV() {
        this.asyncSign = function () {
            return __awaiter(this, void 0, void 0, function () {
                var docpath, pfxpath, doc, page1, builder, writer, certification_sig_field, widgetAnnot, _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, fields_to_lock, element, _l, _m, _o, _p, _q, _r, _s, qr_svg, signatureDate, _t, _u, _v, _w, _x, img, _y, _z, _0, _1;
                return __generator(this, function (_2) {
                    switch (_2.label) {
                        case 0:
                            docpath = 'src/app/Document/CV.pdf';
                            pfxpath = 'src/app/Document/certificatea.pfx';
                        ...
                        case 9:
                            ...
                            _k = parseFloat;
                            return [4 /*yield*/, page1.getPageHeight()];
                        case 10: return [4 /*yield*/, _b.apply(_a, _c.concat([new (_e.apply(_d, _g.concat([_k.apply(void 0, [(_2.sent()).toString()]) - 800])))(), certification_sig_field]))];
                        case 11:
                            widgetAnnot = _2.sent();
                        ...
                        case 16: return [4 /*yield*/, _m.apply(_l, [_2.sent(), 20])];
                        case 17:
                            element = _2.sent();
                        ...
                        case 20:
                            ...
                            _s = parseFloat;
                            return [4 /*yield*/, page1];
                        case 21: return [4 /*yield*/, _p.apply(_o, _q.concat([_s.apply(void 0, [((_2.sent()).getPageHeight()).toString()]) - 760]))];
                        case 22:
                            _2.sent();
                            return [4 /*yield*/, writer.writeElement(element)];
                        case 23:
                        ...
                        case 33: return [4 /*yield*/, _z.apply(_y, [_2.sent()])];
                        case 34:
                            _2.sent();
                        ...
                        case 36: // save changes to the current page
        ...
        this.asyncHash = function (in_docpath) {
            return __awaiter(this, void 0, void 0, function () {
                var license, doc, a, _a, _b;
                return __generator(this, function (_c) {
                    switch (_c.label) {
                        case 0:
                            license = 'demo:omaralami230@gmail.com:7b01f4ab020000000092768e068e8737e8b8c939452e7892e0470df170';
                            return [4 /*yield*/, pdfnet_node_1.PDFNet.initialize(license)];
                        case 1:
                            _c.sent();
    ...
    DocumentSV.prototype.init = function () {
        return __awaiter(this, void 0, void 0, function () {
            var license;
    ...
    DocumentSV.prototype.verify = function (in_docpath) {
        return __awaiter(this, void 0, void 0, function () {
            var doc1, opts, digsig_fitr, verification_status, curr, result, _a, err_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 5:
                        ...
                        this.statu = 1;
                        return [3 /*break*/, 17];
                    case 6: return [4 /*yield*/, digsig_fitr.hasNext()];
                    case 7:
                    ...
                    case 12:
                        ...
                        this.statu = 2;
                        return [3 /*break*/, 15];
                    case 13: return [4 /*yield*/, result.getPermissionsStatus()];
                    case 14:
                        if ((_b.sent()) != 2) {
                            this.statu = 3;
                        }
                        _b.label = 15;
                    case 15: return [4 /*yield*/, digsig_fitr.next()];
                    case 16:
                        _b.sent();
                        return [3 /*break*/, 6];
                    case 17: return [2 /*return*/, this.statu];
                    case 18:
                        err_1 = _b.sent();
